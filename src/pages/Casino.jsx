    ...
    <>
      ...
      <section className="hero">
        <div className="container hero-inner">
          ...
          <p className="lead">
            GrandExchange brings you India's most exciting and secure casino betting experience with live games, 
      ...
      <div className="content">
        <h2>Why Choose GrandExchange for Casino?</h2>
        <ul>
          <li>Live Casino Games Including Roulette, Poker, and Slots</li>
          ...
          <li>24/7 Customer Assistance for Casino Players</li>
          <li>Exclusive Casino Tournaments & Promotions</li>
        </ul>
        <p>Get your instant casino betting ID by contacting our team on WhatsApp.</p>
      </div>
