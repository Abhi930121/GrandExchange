    ...
    <>
      ...
      <div className="content">
        <p className="intro-text">
          Grandexchange.co.in ("we", "our", "us") respects your privacy and is committed to 
        ...
        <div className="policy-section">
          ...
          <ul>
            ...
            <li>You may choose to disable cookies through your browser settings.</li>
          </ul>
        </div>
        ...
        <div className="policy-section">
          ...
          <ul>
            <li>We may use third-party tools or services (such as analytics or payment processors).</li>
        ...
        <div className="policy-section warning-section">
          <div className="section-header">
            <span className="section-number warning">6</span>
            <h2>No Guaranteed Results</h2>
          </div>
          <p>
            Grandexchange.co.in does not guarantee any profits, earnings, or financial outcomes 
