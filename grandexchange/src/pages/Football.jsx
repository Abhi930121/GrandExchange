    ...
    <>
      ...
      <section className="hero">
        <div className="container hero-inner">
          ...
          <p className="lead">
            GrandExchange brings you India's most trusted football betting platform with live match odds, 
      ...
      <div className="content">
        <h2>Why Choose GrandExchange for Football?</h2>
        <ul>
          <li>Live Football Match Odds Updates</li>
          <li>Instant Account Creation & Dedicated Support</li>
          <li>Safe, Secured & Licensed Betting Platform</li>
          <li>Real-Time Betting and Fast Withdrawals</li>
          <li>24/7 Customer Assistance for Football Fans</li>
          <li>Exclusive Football Tournaments & Promotions</li>
        </ul>
      </div>
